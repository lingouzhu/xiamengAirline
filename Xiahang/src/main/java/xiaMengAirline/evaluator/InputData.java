        ...
        while(iterator.hasNext()) {
            ...
            if(transferInInfoMap.containsKey(flightId)){
                ...
                if (totalTransferInPassNum > flight.getSeatNum() - flight.getConnectPassengerNum()
                	...
                	System.out.println(totalTransferInPassNum + "-------"  );
                	System.out.println(flight.getSeatNum() + "-------"  );
                	System.out.println(flight.getConnectPassengerNum() + "-------"  );
                	System.out.println(flight.getPassengerNum() + "-------"  );
