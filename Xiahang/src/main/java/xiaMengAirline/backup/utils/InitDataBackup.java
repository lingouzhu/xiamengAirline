...
import xiaMengAirline.backup.beans.AirPortListBackup;
...
public class InitDataBackup {
	private static final Logger logger = Logger.getLogger(InitDataBackup.class);
